...
//        request.setCoverURL("http://vod.aliyun.com/test_cover_url.jpg");
        request.setCateId(1000296466L);
        request.setTemplateGroupId("ea20aefa7a02828e016833eaa8d7bb33");
    ...
    public static void main(String[] argv) {
        //您的AccessKeyId
        String accessKeyId = "LTAI5tHMFEsmRdVJsfECdZF7";
        //您的AccessKeySecret
        String accessKeySecret = "U3JJNIM2Tt7eH4iMkBo5u2k4ISLLCt";
        //需要上传到VOD的本地视频文件的完整路径，需要包含文件扩展名
        String localFile = "/Users/gs/Downloads/2zpAckrQWY0EWSqK0w88Ow.mp4";
        try {
            // 初始化VOD客户端并获取上传地址和凭证
