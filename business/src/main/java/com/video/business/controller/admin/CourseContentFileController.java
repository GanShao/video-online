...
import com.video.server.dto.CourseContentFileDto;
import com.video.server.dto.ResponseDto;
import com.video.server.service.CourseContentFileService;
...
public class CourseContentFileController {
    ...
    public ResponseDto query(@PathVariable String courseId) {
        ResponseDto responseDto = new ResponseDto();
        List<CourseContentFileDto> fileDtoList = courseContentFileService.query(courseId);
