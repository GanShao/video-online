    ...
    return function (t) {
        ...
        0: function (e, o) {
            ...
            class gt {
                ...
                nodes(t, e) {
                    t = t || b.ok;
                    const o = e && e.includeAncestor, i = e && e.fullyContains, n = this.getStartPoint(),
                        s = this.getEndPoint(), r = [], a = [];
            ...
            var bt = {
                create: function (t, e, o, i) {
                    ...
                    const o = ut.fromOffsetPath(t, e.s.path), i = e.s.offset, n = ut.fromOffsetPath(t, e.e.path),
                        s = e.e.offset;
            ...
            class yt {
                ...
                releaseList(t, e) {
                    ...
                    return n.a.each(t, (t, i) => {
                        const s = y.head(i), r = y.last(i), a = e ? ut.lastAncestor(s, ut.isList) : s.parentNode,
                            l = a.parentNode;
                        if ("LI" === a.parentNode.nodeName) i.map(t => {
                            ...
                            }, {isSkipPaddingBlankHTML: !0}) : null, o = ut.splitTree(a, {
                                node: s.parentNode,
            ...
            class $t {
                ...
                addRow(t, e) {
                    const o = ut.ancestor(t.commonAncestor(), ut.isCell), i = n()(o).closest("tr"),
                        s = this.recoverAttributes(i), r = n()("<tr" + s + "></tr>"),
                ...
                version: "0.8.15", plugins: {}, dom: ut, range: bt, lists: y, options: {
                    ...
                    modules: {
                        editor: class {
                                ...
                                this.$handle = n()(['<div class="note-handle">', '<div class="note-control-selection">', '<div class="note-control-selection-bg"></div>', '<div class="note-control-holder note-control-nw"></div>', '<div class="note-control-holder note-control-ne"></div>', '<div class="note-control-holder note-control-sw"></div>', '<div class="', this.options.disableResizeImage ? "note-control-holder" : "note-control-sizing", ' note-control-se"></div>', this.options.disableResizeImage ? "" : '<div class="note-control-selection-info"></div>', "</div>", "</div>"].join("")).prependTo(this.$editingArea), this.$handle.on("mousedown", t => {
                                    if (ut.isControlSizing(t.target)) {
                                        ...
                                        const e = this.$handle.find(".note-control-selection").data("target"),
                                            o = e.offset(), i = this.$document.scrollTop(), n = t => {
                            ...
                            colorPalette(t, e, o, i) {
                                return this.ui.buttonGroup({
                                    ...
                                    children: [this.button({
                                        ...
                                        click: e => {
                                            e.stopPropagation();
                                            const o = n()("." + t).find(".show"), i = n()(e.target),
                                                s = i.data("event");
                            ...
                            tableMoveHandler(t) {
                                const e = n()(t.target.parentNode), o = e.next(),
                            ...
                            followScroll() {
                                ...
                                const t = this.$editor.outerHeight(), e = this.$editor.width(),
                                    o = this.$toolbar.height(), i = this.$statusbar.height();
                                let s = 0;
                                this.options.otherStaticBar && (s = n()(this.options.otherStaticBar).outerHeight());
                                const r = this.$document.scrollTop(), a = this.$editor.offset().top, l = a - s,
                                    c = a + t - s - o - i;
                            ...
                            update() {
                                ...
                                if (t.isCollapsed() && t.isOnAnchor()) {
                                    ...
                                    i.top -= s.top, i.left -= s.left, this.$popover.css({
                                        display: "block",
                                        left: i.left,
                                        top: i.top
                                    })
                            ...
                            update(t) {
                                ...
                                if (e) {
                                    ...
                                    e.top -= o.top, e.left -= o.left, this.$popover.css({
                                        display: "block",
                                        left: e.left,
                                        top: e.top
                                    })
                            ...
                            createVideoNode(t) {
                                const e = /^(?:(\d+)h)?(?:(\d+)m)?(?:(\d+)s)?$/,
                                    ...
                                    d = t.match(/^.+.(mp4|m4v)$/), u = t.match(/^.+.(ogg|ogv)$/),
                                    p = t.match(/^.+.(webm)$/),
