...
import com.video.server.domain.${Domain};
import com.video.server.domain.${Domain}Example;
import com.video.server.dto.${Domain}Dto;
import com.video.server.dto.PageDto;
import com.video.server.mapper.${Domain}Mapper;
